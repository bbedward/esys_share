package de.esys.esysfluttershare.esysshare;
 ...
 */
public class EsysSharePlugin implements MethodCallHandler {

  private Registrar _registrar;

  private EsysSharePlugin(Registrar registrar) {
  ...
  public static void registerWith(Registrar registrar) {
    ...
    channel.setMethodCallHandler(new EsysSharePlugin(registrar));
  }
